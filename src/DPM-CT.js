  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <group name="Object_4" position={[-3.46, 0, -21.86]} rotation={[-Math.PI / 2, 0, 1.47]} scale={83.84}>
          <group name="Object_5001" />
        </group>
        <group name="Object_7001" position={[-3.46, 0, -21.86]} rotation={[-Math.PI / 2, 0, 1.47]} scale={83.84}>
          <group name="Object_8" />
        </group>
        <group name="Object_10" position={[-3.46, 0, -21.86]} rotation={[-Math.PI / 2, 0, 1.47]} scale={83.84}>
